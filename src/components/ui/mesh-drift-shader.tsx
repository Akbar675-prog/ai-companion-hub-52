...
// "Mesh drift" — blobs shader (WebGL1, no libraries).
const FRAG = `
...
/** Animated WebGL1 "Mesh drift" blobs canvas — fills its positioned parent. */
export function MeshDriftShader({ className }: { className?: string }) {
  ...
  React.useEffect(() => {
    ...
    gl.uniform4f(u("u_cursor"), 0, 2.0, 0.65, 0.46);
    ...
    const frame = (now: number) => {
      resize();
      gl.uniform4f(sceneLoc, canvas.width, canvas.height, ((now - start) / 1000) * 0.73, 4.0);
